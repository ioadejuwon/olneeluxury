...
(function ($) {
  ...
  var totalPriceVariant = function () {
    ...
    var basePrice = parseFloat($(".price-on-sale").data("base-price")) || parseFloat($(".price-on-sale").text().replace("$", "").replace(",", ""));
    ...
    function updateTotalPrice() {
      var currentPrice = parseFloat($(".price-on-sale").text().replace("$", "").replace(",", ""));
