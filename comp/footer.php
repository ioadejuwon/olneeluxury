<footer class="footer -type-5 pt-60 d-none">
    <div class="container">
...
<footer class="footer -type-5 pt-60 bg-dark-2 d-none">
    <div class="container">
...
<footer class="footer -type-1 bg-light-4 -green-links">
    <div class="container">
            ...
            <div class="row y-gap-20 justify-between items-center">
                <div class="col-auto">
                    <div class="footer-header__logo">
                        ...
                        <img class="lg:d-none" src="admin/assets/img/logo.png" alt="logo" style="width: 120px">
                        <!-- <h2>Olnee Luxury</h2> -->
                    </div>
                </div>
                <div class="col-auto">
        ...
        <div class="footer-columns d-none">
            <div class="row y-gap-30">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6">
                    <div class="text-17 fw-500 text-dark-1 uppercase mb-25">GET IN TOUCH</div>
        ...
        <div class="py-30 border-top-dark">
            <div class="row justify-between items-center y-gap-20">
                <div class="col-auto">
                ...
                <div class="col-auto">
                    <div class="d-flex x-gap-20 y-gap-20 items-center flex-wrap">
                        ...
                        <div class="d-none">
                            <a href="#" class="button px-30 h-50 -dark-6 rounded-200 text-dark-1">
                                <i class="icon-worldwide text-20 mr-15"></i><span class="text-15">English</span>
                            </a>
                        </div>
                    </div>
