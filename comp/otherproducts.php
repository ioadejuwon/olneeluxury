      ...
      <div class="row justify-center text-center">
        <div class="col-auto">
          <div class="sectionTitle ">
            <h2 class="sectionTitle__title ">You May Also Like</h2>
            <p class="sectionTitle__text ">Beautifully Functional. Purposefully Designed. Consciously Crafted.</p>
          </div>
        </div>
      </div>

      <div class="row y-gap-30 justify-cente pt-10 lg:pt-20" style="margin:0% auto;">

        <?php
        $prodsql = mysqli_query($conn, "SELECT * FROM products order by RAND() LIMIT 5");
