                ...
                <div class="tabs -active-deep-green-2 js-tabs pt-0">
                    ...
                    <div class="tabs__content py-30 px-30 js-tabs-content">
                        ...
                        <div class="tabs__pane -profile is-activ">
                            ...
                            <div class="border-top-light pt- mt-">
                                <div class="contact-form row y-gap-30">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="text-18 fw-500 lh-1 mt-10 admin-fname"><?php echo $fname; ?> </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="text-16 lh-1  text-dark-1 mb-10">Last Name</div>
                                        <div class="text-18 fw-500 lh-1 mt-10  admin-lname"><?php echo $lname; ?> </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="text-16 lh-1  text-dark-1 mb-10">Email</div>
                                        <div class="text-18 fw-500 lh-1 mt-10 admin-email"><?php echo $admin_email; ?> </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="text-16 lh-1  text-dark-1 mb-10">Phone</div>
                                        <div class="text-18 fw-500 lh-1 mt-10  admin-phone"><?php echo $admin_phone; ?> </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="text-18 fw-500 lh-1 mt-10 admin-address"><?php echo $address; ?> </div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tabs__pane -edit-profile is-activ">
                            ...
                            <div class="border-top-light">
                                <form action="#" id="edit_account" class="contact-form row y-gap-10">
                                    <div class="col-md-6">
                                        <label class="text-16 lh-1 fw-500 text-dark-1 mb-10">First Name</label>
                                        <input type="text" name="fname" value="<?php echo $fname; ?>" placeholder="First Name">
                                        <input type="hidden" name="user_id" value="<?php echo $user_id; ?>" placeholder="First Name">
                        ...
                        <div class="tabs__pane -social-info">
                            <form id="edit_socials" class="contact-form row y-gap-30">
                                ...
                                <div class="col-md-6">
                                    <label class="text-16 lh-1 fw-500 text-dark-1 mb-10">Facebook link</label>
                                    <input type="text" name="facebook" placeholder="Facebook Profile">
                                </div>
                                <div class="col-12">
                                    <button class="button -md -deep-green-1 text-white">Save Social Profile</button>
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="tabs__pane -tab-item-6">
                            <form action="#" class="contact-form row y-gap-30">
                                ...
                                <div class="col-12">
                                    <button class="button -md -deep-green-1 text-white">Close Account</button>
                                </div>
                            </form>
                        </div>
                    </div>
